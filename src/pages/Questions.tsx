...
const Questions: React.FC = () => {
    ...
    const handleOpenModal = (question?: Question) => {
        if (question) {
            ...
            // Generate a temporary ID or let the user define it. For now, let's auto-generate a timestamp-based one if empty
            // But the user might want to follow the format "q_exam_year_cat_001"
            setFormData({ ...initialFormState, id: `q_${Date.now()}` });
        }
        setIsModalOpen(true);
    };
